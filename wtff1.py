...
<Jutt>This Is saahir heree</Badshah>
...
<h1>installation</h1>
    ...
    <li>rm -rf $HOME/SaadKhan
    <li>git clone https://github.com/Saad-Khan/Khan-Saad</li>
    <li>cd $HOME/SaadKhan</li>
    <li>python Saadkhan.py</li>
</ul>
<h1>Usage</h1>
<li>cd $HOME/Khansaad</li>
<li>python Khansaad.py</li>
</ul>
<h1>My Contact Links</h1>
<p>Personal Chat Whatsapp <a href="https://bit.ly/3qANBWS" target="_blank">Click</a>.</p>
<p>Whatsapp Group <a href="https://chat.whatsapp.com/FMyANytaKQIKf8gZ8JOChA" target="_blank">Click</a>.</p>
</ul>
<h1>Disclaimer</h1>
